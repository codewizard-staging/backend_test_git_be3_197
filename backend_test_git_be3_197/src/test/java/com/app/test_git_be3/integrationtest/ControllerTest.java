package com.app.test_git_be3.integrationtest;
...
import com.app.test_git_be3.SpringApp;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("test_git_be3", n.getAttribute("Namespace"));
  ...
  given()
   ...
   given()
            .when()
            .get("/test_git_be3/PetServices?$top=1")
            .then()
    ...
    given()
            .when()
            .get("/test_git_be3/PetServices/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/test_git_be3/PetOwners?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/test_git_be3/PetOwners/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  void  testCreatePetCareCenterInstance() throws IOException {
    given()
        ...
        .when()
        .post("/test_git_be3/PetCareCenters")
        .then()
        .statusCode(HttpStatusCode.CREATED.getStatusCode());
  ...
  given()
   ...
   given()
            .when()
            .get("/test_git_be3/PetCareCenters?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/test_git_be3/PetCareCenters/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  given()
   ...
   given()
            .when()
            .get("/test_git_be3/Documents?$top=1")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
    ...
    given()
            .when()
            .get("/test_git_be3/Documents/$count")
            .then()
            .statusCode(HttpStatusCode.fromStatusCode(200).getStatusCode())
            .body(is("1"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM test_git_be3.PetService");
    jdbcTemplate.execute("DELETE FROM test_git_be3.PetOwner");
    jdbcTemplate.execute("DELETE FROM test_git_be3.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM test_git_be3.Document");
    jdbcTemplate.execute("DELETE FROM test_git_be3.Pet");
     jdbcTemplate.execute("DELETE FROM test_git_be3.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM test_git_be3.PetCareCenterImages");
